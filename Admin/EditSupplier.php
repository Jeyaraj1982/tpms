                                    ...
                                    <div class="row">
                                        ...
                                        <form method="post" action="" onsubmit="return submitSupplierDetails();">
                                            ...
                                            <div class="form-group form-inline">
                                                ...
                                                <div class="col-sm-4"><input type="text" class="form-control" id="AddressLine2" name="AddressLine2" value="<?php echo (isset($_POST['AddressLine2']) ? $_POST['AddressLine2'] : $Supplier[0]['AddressLine2']);?>" placeholder="Enter Address Line 2" style="width:100%"></div>
                                            </div>
                                            <div class="form-group form-inline">
                                                <div class="col-sm-2">Address Line 3</div>
                                                <div class="col-sm-4"><input type="text" class="form-control" id="AddressLine3" name="AddressLine3" value="<?php echo (isset($_POST['AddressLine3']) ? $_POST['AddressLine3'] : $Supplier[0]['AddressLine3']);?>" placeholder="Enter Address Line 3" style="width:100%"></div>
                                            </div>
                                            <div class="form-group form-inline">
                                            ...
                                            <div class="col-sm-2">Landline Number</div>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" id="LandlineNumber"  name="LandlineNumber" value="<?php echo (isset($_POST['LandlineNumber']) ? $_POST['LandlineNumber'] : $Supplier[0]['LandlineNumber']);?>" placeholder="Enter Landline Number" style="width:100%">
